...
def extract_feats(params, model, load_image_fn):
    global C, H, W, samples, sample, image_list
    model.eval()
    ...
    for video in tqdm(video_list):
        ...
        if os.path.join(video_id+'.npy') in os.listdir(dir_fc):
            pass
        else:
            ...
            if len(image_list) == 0:
               ...
               # print('pass!')
                #pass
                #shutil.remove(os.path.join(dst, video))
...
if __name__ == '__main__':
    ...
    parser.add_argument("--output_dir", dest='output_dir', type=str,
                        default='/home/diml/hdd/feats/resnet152', help='directory to store features')
    parser.add_argument("--n_frame_steps", dest='n_frame_steps', type=int, default=24,
                        help='how many frames to sampler per video')

    parser.add_argument("--video_path", dest='video_path', type=str,
                        default='/home/diml/hdd/train', help='path to video dataset')
